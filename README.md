...
├── draft.ipynb            # EDA, feature engineering exploration

├── main.py                # Main pipeline: data loading, feature engineering,

│                          # preprocessing, CV training, hyperparameter tuning, submission
...
**1. Clone the repo**
'''bash
git clone <https://github.com/fyodor077/Kaggle-Titanic-Disaster>
cd titanic
'''
